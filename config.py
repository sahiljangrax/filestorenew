...
APP_ID = int(os.environ.get("APP_ID", "29527581"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "81fa1c4f2995ee7e73d4ba4610f818c9")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002433676879"))
